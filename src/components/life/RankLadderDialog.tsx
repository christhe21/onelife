              ...
              {RANK_TIERS.map((tier, i) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={cn(
                        "flex h-full min-h-[14rem] flex-col gap-3 rounded-xl border p-4 sm:min-h-[16rem] sm:gap-4 sm:p-5",
                        isCurrent
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div
                          className={cn(
                            "flex h-16 w-16 shrink-0 items-center justify-center rounded-xl sm:h-[4.5rem] sm:w-[4.5rem]",
                            isCurrent ? "bg-primary/10" : "bg-muted/60",
                          )}
                        >
                          <RankIcon rank={tier.name} className="h-14 w-14 sm:h-16 sm:w-16" />
                        </div>
