...
export const ANIME_QUOTES: AnimeQuote[] = [
  ...
  {
    kind: "anime",
    text: "It's just ten years for you, but for me it's a quarter of my life. It felt like an eternity.",
    character: "Himmel",
    anime: "Frieren: Beyond Journey's End",
  },
  {
    kind: "anime",
    text: "A real hero doesn't need a reason to save someone.",
    character: "Himmel",
    anime: "Frieren: Beyond Journey's End",
  },
  {
  ...
  {
    kind: "anime",
    text: "Don't believe in yourself. Believe in the me that believes in you.",
    character: "Kamina",
    anime: "Gurren Lagann",
  },
  {
